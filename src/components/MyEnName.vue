<template>
  ...
  >
    <div class="flex overflow-hidden">
      ...
      <span class="letter font-title! font-black inline-block translate-y-full will-change-transform">Y</span>
      <span class="letter font-title! font-black inline-block translate-y-full will-change-transform">R</span>
