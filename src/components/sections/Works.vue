...
<script setup lang="ts">
  ...
  const selectedWorksProps = [
    {
      name: 'VA Freelance Hub',
      category: 'Autonomous Jobs Engine',
    ...
    },
    {
      ...
      tags: ['LLM', 'AI', 'Markdown', 'Docs-as-code'],
      videoSrc: work3,
      imageBg: workBg3,
      url: 'https://github.com/cyalcala/techwriter-bot',
      year: '2024',
    },
    {
      name: 'Autonomous Workflows',
      category: 'Workflow & CRM Automation',
      tags: ['n8n', 'Zapier', 'APIs', 'GoHighLevel'],
      videoSrc: work1,
      imageBg: workBg1,
    ...
    },
    {
      ...
      tags: ['Markdown', 'Docusaurus', 'GitHub Actions'],
      videoSrc: work4,
      imageBg: workBg4,
